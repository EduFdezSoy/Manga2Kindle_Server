/**
 * This script works for mariadb and mysql
 * Tested only in mariadb
 *
 * @author Eduardo Fernandez
 * @website https://edufdez.es/
 */
...
CREATE TABLE IF NOT EXISTS chapter (
    ...
    CONSTRAINT fk_chapter_manga
        ...
        ON DELETE CASCADE
        ON UPDATE CASCADE,
    CONSTRAINT fk_chapter_language
